...
export default function ProfilePage() {
    ...
    if (loading) return <div className="text-center text-gray-500 dark:text-gray-300 mt-20">Loading...</div>;
    if (!profile) return <div className="text-center text-gray-500 dark:text-gray-300 mt-20">No profile data</div>;

    return (
        <div className="max-w-md mx-auto mt-20 p-6 bg-white dark:bg-gray-800 shadow rounded-lg text-gray-900 dark:text-white">
